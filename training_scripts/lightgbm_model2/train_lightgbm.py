...
def branch_and_colour_sweep(
    ...
    branch_probs = calibrated_probabilities(model, calibrator, prepare_x(pd.DataFrame(branch_rows), categories))
    ...
    colour_probs = calibrated_probabilities(model, calibrator, prepare_x(pd.DataFrame(colour_rows), categories))

...
- Code that makes this data: [`model_1/dataset_scripts/`](../dataset_scripts/)
...
- All settings live in `model_1/dataset_scripts/config.yaml`.
- There are no hard-coded numbers in the Python.
- File paths in that config are relative to `model_1/`.
- `model_1/data/` contains the generated dataset.

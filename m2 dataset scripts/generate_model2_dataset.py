...
SRC = "/mnt/user-data/uploads/customers.csv"
...
write_jsonl(f"{OUT_DIR}/individual_dataset.jsonl", individual_examples)
write_jsonl(f"{OUT_DIR}/cohort_dataset.jsonl", cohort_examples)
write_jsonl(f"{OUT_DIR}/model2_training_data.jsonl", individual_examples + cohort_examples)
